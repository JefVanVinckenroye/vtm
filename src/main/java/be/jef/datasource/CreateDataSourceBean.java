...
public class CreateDataSourceBean {
	...
	DataSource dataSource() {
		...
		if (environment.containsProperty("OPENSHIFT_MYSQL_DB_HOST")) {
		 ...
		 environment.getProperty("openshift.driverClassName"));
		 dataSource.setUsername(
		 environment.getProperty("OPENSHIFT_MYSQL_DB_USERNAME"));
		 dataSource.setPassword(
		 environment.getProperty("OPENSHIFT_MYSQL_DB_PASSWORD"));
		} else {
